...
import static bg.softuni.gamestore.constants.Validations.USERNAME_OR_PASSWORD_NOT_VALID_MESSAGE;
...
public class UserServiceImpl implements UserService{
    ...
    public String logoutUser() {
        ...
        String logoutUserName = this.loggedInUser.getFullName();
        this.loggedInUser = null;
        return "User " + logoutUserName + " successfully logged out";
    }

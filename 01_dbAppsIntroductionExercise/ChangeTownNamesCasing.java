...
public class ChangeTownNamesCasing {
    ...
    private static final String COUNT_OF_TOWNS_AFFECTED_MESSAGE = "%d town names were affected.%n";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.printf(COUNT_OF_TOWNS_AFFECTED_MESSAGE, updatedCount);
        ...
        while (allTownsResult.next()) {
            towns.add(allTownsResult.getString(Constants.COLUM_LABEL_NAME));
        }
